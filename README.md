...
titles only!
- Implement multi-screen navigation where the selected Recipe object is passed to the detail screen.
all details go in here!
- Add a + button that allows the user to add a recipe via a simple form
